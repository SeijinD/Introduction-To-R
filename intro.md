...
- Οι λίστες και γενικά ξεκινάν με το 1 και όχι με το 0. 
  πχ: list[1] => Είναι το πρώτο στοιχείο της λίστας. 
- rm(var1,var2) = Αφαιρεί τα αντικείμενα var1 και var2.
...
- %*% <- Εωτερικό γινόμενο διανυσμάτων ή πολλαπλασιασμός πινάκων
